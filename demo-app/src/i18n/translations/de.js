const de = {
  ...
  chat: {
    ...
    uploadFootnote: 'Unterstuetzte Dateien: PDF, Excel, Word, PowerPoint, Markdown (max. 25 MB)',
    fileTooLarge: 'Datei ist zu gross. Maximale Groesse ist {maxSize}.',
    fileTypeError:
      'Nicht unterstuetzter Dateityp. Lade PDF-, Excel-, Word-, PowerPoint- oder Markdown-Dateien hoch.',
    selectedFileLabel: 'Ausgewaehlte Datei',
    removeAttachmentAria: 'Anhang entfernen',
    removeAttachmentLabel: 'Entfernen',
    previewArtifactLabel: 'Vorschau',
    ...
    previewPanelAria: 'Dateivorschau',
    previewTabLabel: 'Vorschau',
    previewInfoTabLabel: 'Details',
    previewCloseAria: 'Dateivorschau schliessen',
    previewEmptyTitle: 'Datei aus dem Chat oeffnen',
    previewEmptyCopy: 'Hier erscheinen Vorschauen mit Inline-Ansicht und Metadaten.',
    previewInlineUnavailable: 'Inline-Vorschau ist fuer diesen Dateityp noch nicht verfuegbar.',
    ...
    previewKindSpreadsheet: 'Tabelle',
    previewKindDocument: 'Dokument',
    previewKindPresentation: 'Praesentation',
    previewKindFile: 'Datei',
    previewSourceLabel: 'Quelle',
    previewSourceGenerated: 'Vom Agenten erzeugt',
    previewSourceUploaded: 'Im Chat hochgeladen',
    previewTypeLabel: 'Typ',
    previewSizeLabel: 'Groesse',
    previewRowsLabel: 'Zeilen',
    previewColumnsLabel: 'Spalten',
    previewLinesLabel: 'Zeilen',
    previewSheetsLabel: 'Blaetter',
    previewSlidesLabel: 'Folien',
    previewParagraphsLabel: 'Absaetze',
    previewWordsLabel: 'Woerter',
    previewSheetEmpty: 'Dieses Blatt ist leer.',
    previewMarkdownEmpty: 'Diese Markdown-Datei ist leer.',
    previewDocumentEmpty: 'Dieses Dokument enthaelt keinen extrahierbaren Text.',
    previewPresentationEmpty: 'Diese Praesentation enthaelt keinen extrahierbaren Text.',
    previewSlideEmpty: 'Diese Folie enthaelt keinen extrahierbaren Text.',
    previewSheetTabsAria: 'Arbeitsblaetter',
    previewSlideTabsAria: 'Praesentationsfolien',
    previewSlideLabel: 'Folie {index}',
    previewTableTruncated: 'Es werden die ersten {rows} Zeilen und {columns} Spalten gezeigt.',
    previewDetailsTitle: 'Dateidetails',
  },
  agents: {
    'excel-analyst': {
      name: 'Excel-Analyst',
